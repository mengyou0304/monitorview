...
import com.robin.source.FaultDataSource;
 ...
 */
@Title("LogicMonitorView")
@Theme("valo")
public class AddressbookUI extends UI {
	String[] viewss=new String[]{"errolevel","userid","day", "hour","minute"
			,"dtoffset","lag","size"};
...
//					System.out.println("key: "+ks+" /t value: "+vs);
	...
	private class ContactFilter implements Filter {
		...
		public boolean passesFilter(Object itemId, Item item) {
			String haystack = ("" + item.getItemProperty("userid").getValue()
					+ item.getItemProperty("day").getValue() + item
					.getItemProperty("hour").getValue()).toLowerCase();
	...
	private void initContactList() {
		...
		contactList.setVisibleColumns(viewss);
